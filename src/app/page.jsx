      ...
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="">
          ...
          <p className="mt-6 text-xl text-neutral-600">
            The core mission of our team is to assist local companies in Singapore through their digital transformation journey. <br></br>Our range of services encompass:</p>
          <div className="mt-6 text-xl text-neutral-600 grid md:grid-cols-2 gap-4">

            <div className="p-8 rounded-2xl bg-neutral-950 border-[3px] border-[#2b65cb] text-neutral-300 shadow">
              {/* icon */}
              <div>
                <svg width="48" height="auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24 0H0V24H24V0Z" />
                  <path d="M14.32 8.09998C14.67 7.90998 14.97 7.64998 15.22 7.34998C15.72 6.77998 16.01 6.01999 16.01 5.20999C16.01 3.37999 14.52 1.88998 12.69 1.88998C11.36 1.88998 10.22 2.66999 9.69001 3.79999C9.16001 2.66999 8.02001 1.88998 6.69001 1.88998C4.86001 1.88998 3.38001 3.37999 3.38001 5.20999C3.38001 6.01999 3.67001 6.77998 4.17001 7.34998C4.41001 7.64998 4.72001 7.89998 5.06001 8.09998C3.30001 8.59998 2.01001 10.22 2.01001 12.15V15.61C2.01001 17.94 3.90001 19.83 6.22001 19.83H13.16C14.94 19.83 16.47 18.72 17.08 17.16C17.27 16.7 17.37 16.2 17.38 15.67V12.09C17.37 11.56 17.27 11.06 17.08 10.6C16.61 9.38998 15.59 8.44998 14.32 8.09998Z" fill="white" />
                  <path d="M21.19 9.92998C20.67 9.57998 20.01 9.49996 19.43 9.71996L18.02 10.25C18.2 10.71 18.32 11.2 18.36 11.72C18.37 11.86 18.38 12 18.38 12.15V15.61C18.38 15.76 18.37 15.9 18.36 16.04C18.32 16.56 18.2 17.05 18.02 17.51L19.43 18.04C19.65 18.12 19.87 18.16 20.1 18.16C20.48 18.16 20.86 18.05 21.19 17.82C21.7 17.47 22.01 16.88 22.01 16.26V11.5C22.01 10.88 21.7 10.29 21.19 9.92998Z" fill="white" />
                </svg>
              </div>

              <strong className="block font-display text-white">Product Shooting:</strong>

              Our professional team of photographers and models work together to create high-quality images and videos of your products. Use the assets on websites and social media to expand your brand.
            </div>
