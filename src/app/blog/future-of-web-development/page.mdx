...
export const article = {
  date: '2023-10-06',
  title: 'The Future of Web Development: Our Predictions for AI Programming',
  description:
    'Let’s explore the latest trends in web development, and experiment with AI programming.',
  author: {
    name: 'KeYi',
